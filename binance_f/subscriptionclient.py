...
class SubscriptionClient(object):
    ...
    def __create_connection(self, request, http_proxy_host=None, http_proxy_port=None):
        connection = WebsocketConnection(self.__api_key, self.__secret_key, self.uri, self.__watch_dog, request)
        self.connections.append(connection)
        # 自定义修改
        connection.connect(http_proxy_host, http_proxy_port)
    ...
    def subscribe_symbol_ticker_event(self, symbol: 'str', callback, error_handler=None, http_proxy_host=None, http_proxy_port=None):
        """
        ...
        # 自定义修改
        self.__create_connection(request, http_proxy_host, http_proxy_port)
    ...
    def subscribe_user_data_event(self, listenKey: 'str', callback, error_handler=None, http_proxy_host=None, http_proxy_port=None):
        """
        User Data Streams
        """
